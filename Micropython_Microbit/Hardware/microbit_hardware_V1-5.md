...
-   The [schematics](https://tech.microbit.org/hardware/schematic), which shows the detailed component
...
The two buttons on the front of the micro:bit, and the 1 button on the
